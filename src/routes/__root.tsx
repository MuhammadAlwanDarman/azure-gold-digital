...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
 ...
 { name: "author", content: "PKBM Zaid bin Tsabit" },
 ...
 { name: "twitter:title", content: "PKBM Zaid bin Tsabit — Pusat Kegiatan Belajar Masyarakat Teknologi Unggulan" },
 { name: "twitter:description", content: "PKBM Zaid bin Tsabit: pusat kegiatan belajar masyarakat modern jenjang TK, SD, SMP, SMA dengan program tahfizh, coding, robotik, dan AI. SPMB online kini dibuka." },
